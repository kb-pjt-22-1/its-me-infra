...
-- 김베네 - its-me-backend 02_seed.sql의 user_id=24와 짝을 맞춘 카드 추천/실적(구간)
-- 테스트 시나리오 전용 고객. ci_hash = SHA-256("김베네"+"20010101"+"010-1234-1234")
-- (다른 고객들과 달리 생년월일/전화번호는 원래 요청대로 20010101/010-1234-1234 유지).
INSERT INTO mock_customers
(
    mock_customer_id,
    ci_hash,
...
VALUES
    (
        11,
        '5a324c11dc37b6d2f07254f34773912dddd9f8e122c7f285d4febc0cdd3caddd',
        'KB-CUSTOMER-0011',
        '김베네',
        'ACTIVE'
    );
...
VALUES
    ...
    -- =====================================================
    -- 고객 11: 김베네 / 총 4장 (its-me-backend user_cards 67~70과 값이 동일해야 함)
    -- 굿데이올림카드(VISA)
    -- ALL 카드(DOMESTIC)
    -- 마이핏카드(할인형)(DOMESTIC)
    -- 가온 올포인트 체크카드(DOMESTIC)
    -- =====================================================
    (31, 11, 27, 'KB-CARD-0067', '5001', '203112', 'ACTIVE', '2025-06-15 10:00:00', 'KB-TOKEN-0067', '9475000000005001', '2031-12-31', 'ACTIVE'),
    (32, 11, 14, 'KB-CARD-0068', '5002', '203112', 'ACTIVE', '2025-06-15 10:00:00', 'KB-TOKEN-0068', '9475000000005002', '2031-12-31', 'ACTIVE'),
    (33, 11, 18, 'KB-CARD-0069', '5003', '203112', 'ACTIVE', '2025-06-15 10:00:00', 'KB-TOKEN-0069', '9475000000005003', '2031-12-31', 'ACTIVE'),
    (34, 11, 50, 'KB-CARD-0070', '5004', '203112', 'ACTIVE', '2025-06-15 10:00:00', 'KB-TOKEN-0070', '9475000000005004', '2031-12-31', 'ACTIVE');